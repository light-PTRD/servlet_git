...
<body background="resources/images/back.gif" style="background-color:white">
    <center>
        ...
        <table border="0" width="220px" height="auto" cellspacing="0" cellpadding="0" style="margin-top:7px;background-color:white">
            ...
            <tr>
                <td align="center" valign="top" style="border:1px solid">
                    <table border="0" width="220px" height="80px" cellspacing="0"  style="font-size:12px">
                        <tr height="25px"><td align="center" valign="bottom">请输入要查询的用户ID：</td></tr>
                        <tr height="40px">
                            <td align="center">
            ...
            <tr>
                <td align="center" valign="top" style="border:1px solid">
                    <table border="0" width="215px" height="150px" cellspacing="0" style="font-size:12px">
                        <tr>
            ...
            <tr>
                <td align="center" valign="top" style="border:1px solid">
                    <table border="0" width="220" height="80" cellspacing="0"  style="font-size:12px">
                        ...
                        <tr height="40">
                            <td align="center">
                                <input type="text" name="infoid" value="" size="20"/>
                                <input type="submit" value="查询"/>
                            </td>
                        </tr>
                    </table>
